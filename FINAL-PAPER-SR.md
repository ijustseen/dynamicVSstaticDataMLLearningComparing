...
Извор: Urdu-Multimodal-Emotion-Dataset (коришћен визуелни модалитет).
...
Слика 3 - Матрица грешака optimized за статички модел (lr=1e-4, label_smoothing=0.05, patience=10).

![Optimized dynamic confusion matrix](experiment/results/experiments/lr1e4_ls005_pat10_bestacc/confusion_dynamic_opt.png)

Слика 4 - Матрица грешака optimized за динамички модел (lr=1e-4, label_smoothing=0.05, patience=10).

![Training curves static optimized](experiment/results/latest/training_static_opt.png)

Слика 5 - Криве обуке static модела: динамика train/val loss и train/val accuracy по епохама.

![Training curves dynamic optimized](experiment/results/latest/training_dynamic_opt.png)

Слика 6 - Криве обуке dynamic модела: динамика train/val loss и train/val accuracy по епохама.
